...
public class inicio extends javax.swing.JFrame {
    ...
    public inicio() {
        ...
        jButton2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jButton2MouseEntered(evt); // Corrige "MouseEntered" a "mouseEntered"
            }

            public void mouseExited(java.awt.event.MouseEvent evt) {
                jButton2MouseExited(evt); // Corrige "MouseExited" a "mouseExited"
            }
        });
           jButton3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jButton3MouseEntered(evt); // Corrige "MouseEntered" a "mouseEntered"
            }

            public void mouseExited(java.awt.event.MouseEvent evt) {
                jButton3MouseExited(evt); // Corrige "MouseExited" a "mouseExited"
            }
        });
    ...
    private void initComponents() {
        ...
        nombre.setFont(new java.awt.Font("Stencil", 0, 36)); // NOI18N
        nombre.setForeground(new java.awt.Color(255, 255, 255));
        nombre.setText("cinestelar");
        ...
        jButton2.setText("Estrenos");
        jButton2.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED, java.awt.Color.black, java.awt.Color.cyan, java.awt.Color.gray, java.awt.Color.green));
        jButton2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2btnCambiar(evt);
            }
        });

        jButton3.setBackground(new java.awt.Color(204, 255, 255));
        jButton3.setFont(new java.awt.Font("Yu Gothic Medium", 1, 18)); // NOI18N
        jButton3.setText("Clasicos");
        jButton3.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED, java.awt.Color.black, java.awt.Color.cyan, java.awt.Color.gray, java.awt.Color.green));
        jButton3.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3btnCambiar(evt);
            }
        });
    ...
    private void jButton2btnCambiar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2btnCambiar
    ...
    private void jButton2MouseExited(java.awt.event.MouseEvent evt) {
        jButton2.setBackground(new java.awt.Color(204,255,255)); // Restablece el fondo .
    }
    //////////////////////
    ...
    private void jButton3MouseExited(java.awt.event.MouseEvent evt) {
        jButton3.setBackground(new java.awt.Color(204,255,255)); // Restablece el fondo .
    }
    /**
